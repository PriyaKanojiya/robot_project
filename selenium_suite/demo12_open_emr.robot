...
TC1
    ...
    Input Text    xpath=//input[@id='form_fname']    priya
    Input Text    xpath=//input[@id='form_lname']    k
    Click Element    xpath=//input[@id='form_DOB']
    Input Text    xpath=//input[@id='form_DOB']    24/01/2000
    ...
    Element Should Contain    xpath=//span[text()='priya k']    priya k
    Sleep    5s
    Close Browser
